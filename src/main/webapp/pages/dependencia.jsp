...
<html lang="en">
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <form action="DependenciaServlet" method="POST">
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Gestionar Dependencias</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <div class="panel panel-primary">
                                            ...
                                            <th colspan="11">
                                                <div class="form-group">
                                                    <h3>Nombre:
                                                     ...
                                                     <div class="form-group">
                                                         <c:choose>
                                                             <c:when test="${not empty requestScope.dependencia}">
                                                                <input class="form-control" name="dependencia" placeholder="Enter text" value="<c:out value="${requestScope.dependencia.nombre}"/>" />
                                                                <input type="hidden" name="id" value="<c:out value="${requestScope.dependencia.id}"/>" />
                                                            </c:when>
                                                            <c:otherwise>
                                                              <input class="form-control"  name="dependencia" placeholder="Enter text"/>
                        ...
                        <div align="center" class="panel-footer">
                             ...
                             <c:choose>
                                <c:when test="${not empty requestScope.dependencia}">
                                 <button type="submit" class="btn btn-default">Actualizar Dependencia</button> 
                               </c:when>
                               <c:otherwise >
                                  <button type="submit" class="btn btn-default">Ingresar Dependencia</button> 
                               </c:otherwise>
                            </c:choose>
