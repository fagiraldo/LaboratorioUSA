                ...
                <div id="page-wrapper">
                    ...
                    <div class="panel panel-primary">
                        ...
                        <div class="input-group custom-search-form">
                            <input type="text" name="preventivo" class="form-control" placeholder="Search..." required>
                            ...
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-striped table-bordered table-hover">
                                        ...
                                        <tbody>
                                            <c:forEach items="${activo.mantenimientoPreventivo}" var="preventivo" varStatus="varStatus">
                                            <tr>
                               ...
                               <a href="#" data-href="MantenimientoServlet?preventivo=${preventivo.id}" data-toggle="modal" data-target="#confirm-delete" class="btn btn-info" role="button">Borrar</a>
                   ...
                   <form action="MantenimientoServlet" method="POST">    
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-body">
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="4">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea name="actividad" class="form-control" rows="3"></textarea>
                                                ...
                                                <th colspan="3">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            <textarea name="materiales" class="form-control" rows="3"></textarea>
                                                        </div>
                                                    </div></th>
                                                <td></td>
                                            </tr>
                            ...
                            <div align="center">
                                <button type="submit" name="preventivo" class="btn btn-default">Adicionar Mantenimientos</button>
                            </div>
