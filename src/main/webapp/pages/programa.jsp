        ...
        <div id="wrapper">
            ...
            <form action="ProgramaServlet" method="POST">
                <div id="page-wrapper">
                    <div class="row">
                        <div class="col-lg-12">
                            <h1 class="page-header">Gestionar Programas</h1>
                        </div>
                        <!-- /.col-lg-12 -->
                    </div>
                    ...
                    <div class="panel panel-primary">
                                            ...
                                            <th colspan="11">
                                                <div class="form-group">
                                                    <h3>Nombre:
                                                     ...
                                                     <div class="form-group">
                                                         <c:choose>
                                                             <c:when test="${not empty requestScope.programa}">
                                                                <input class="form-control" name="programa" placeholder="Enter text" value="<c:out value="${requestScope.programa.nombre}"/>" />
                                                                <input type="hidden" name="id" value="<c:out value="${requestScope.programa.id}"/>" />
                                                            </c:when>
                                                            <c:otherwise>
                                                              <input class="form-control"  name="programa" placeholder="Enter text"/>
                        ...
                        <div align="center" class="panel-footer">
                             ...
                             <c:choose>
                                <c:when test="${not empty requestScope.programa}">
                                 <button type="submit" class="btn btn-default">Actualizar Programa</button> 
                               </c:when>
                               <c:otherwise >
                                  <button type="submit" class="btn btn-default">Ingresar Programa</button> 
                               </c:otherwise>
                            </c:choose>
